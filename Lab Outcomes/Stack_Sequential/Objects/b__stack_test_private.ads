...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_stack_test_private" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d6e0a94a#;
   pragma Export (C, u00001, "stack_test_privateB");
   ...
   u00094 : constant Version_32 := 16#d85792d6#;
   pragma Export (C, u00094, "ada__tagsB");
   u00095 : constant Version_32 := 16#8813468c#;
   ...
   u00114 : constant Version_32 := 16#8cfe1563#;
   pragma Export (C, u00114, "stack_pack_genericB");
   u00115 : constant Version_32 := 16#4a0db07e#;
   pragma Export (C, u00115, "stack_pack_genericS");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  stack_pack_generic%s
   --  stack_pack_generic%b
   --  stack_test_private%b
