...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_stack_test_generic" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2a5d2aaf#;
   pragma Export (C, u00001, "stack_test_genericB");
